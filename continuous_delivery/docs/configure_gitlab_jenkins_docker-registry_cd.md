...
> You could take a look at `Jenkinsfile` [here](https://github.com/apenella/provisioning/blob/master/continuous_delivery/files/default/test/simple-go-helloworld/Jenkinsfile).
